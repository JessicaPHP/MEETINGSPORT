 ...
 * Membres
 *
 * @ORM\Table(name="membres",indexes={@ORM\Index(name="idSport")})
 * @ORM\Entity
 */
class Membres
{
    ...
    * @return Sports
    */
    public function setIdsport(\Test\CrudBundle\Entity\Membres $idsport = null)
    {
    ...
    /**
     * Set abonnementnewsletter
     *
     * @param boolean $abonnementnewsletter
     *
     * @return Membres
     */
