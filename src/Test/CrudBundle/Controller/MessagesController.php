...
use Test\CrudBundle\Entity\Messages;
...
class MessagesController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $messages = $em->getRepository('TestCrudBundle:Messages')->findAll();
    ...
    {
        $message = new Message();
        $form = $this->createForm('Test\CrudBundle\Form\MessagesType', $message);
    ...
    {
        $deleteForm = $this->createDeleteForm($message);
        $editForm = $this->createForm('Test\CrudBundle\Form\MessagesType', $message);
